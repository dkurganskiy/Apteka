...
for i in range(len(linklist)):
    ...
    try:
        ...
        items = soup.find_all("div",
                              class_="ui-card ui-card_size_default ui-card_outlined goods-card goods-grid__cell goods-grid__cell_size_3")
        if not items:
            print("не туда")
...
print(prep)
with open(rf"C:\Users\danil\OneDrive\Документы\Python\Аптечка\Результаты парсинга\apteka-ot-sklada{date}.csv", 'w', newline='', encoding='utf-8') as file:
