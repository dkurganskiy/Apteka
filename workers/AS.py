...
def job():
    ...
    try:
        class antey(object):
            ...
            print(prep)
            with open(f"Antey_{date}.csv", 'w', newline='', encoding="utf-8") as file:
                writer = csv.writer(file, delimiter=';')
                writer.writerow(
                    ['Дата', 'Наименование препарата как у нас', 'Наименование препарата как у аптеки', 'Наименование АС',
                     'Ссылка на препарат', 'Город', 'Цена'])
    ...
    try:
        class gubernskieApteki(object):
            ...
            print(prep)
            with open(f"gubernskiyApteki_{date}.csv", 'w', newline='') as file:
                writer = csv.writer(file, delimiter=';')
                writer.writerow(
                    ['Дата', 'Наименование препарата как у нас', 'Наименование препарата как у аптеки', 'Наименование АС',
                     'Ссылка на препарат', 'Город', 'Цена'])
    ...
    try:
        class poiskLekarstv(object):
            ...
            for i in range(len(linklist)):
                ...
                with open(f"Аптечные сети{date}.csv", 'a', newline='') as file:
                    writer = csv.writer(file, delimiter=';')
                    writer.writerow(['Дата', 'Наименование препарата как у нас', 'Наименование препарата как у аптеки',
                                     'Наименование АС', 'Ссылка на препарат', 'Город', 'Цена'])
                    for item in prep:
    ...
    try:
        class socialApteka(object):
            ...
            linklist = [
                ...
                "https://social-apteka.ru/catalog/bolezni-sustavov/ameloteks-r-r-d-in-1-5ml-n5-soteks_33449/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/armaviskon-r-r-dvnutrisust-vved-2ml-2_1549818/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/armaviskon-plyus-r-r-dvnutrisust-vved-2ml-86_1549819/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/armaviskon-forte-r-r-dvnutrisust-vved-shpric-3ml-53_29463/",
                "https://social-apteka.ru/catalog/kat/armaviskon-hondro-protez-sinovialnoy-jidkosti-3ml-n1-groteks-7_34113316/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/artogistan-r-r-din-100mgml-2ml-n10-41_28657/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/genitron-r-r-din-10mgml-15ml-n5-74_27287/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/gialurom-r-r-vsustav-shpric-15-2ml-n1-90_38239/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/gialurom-cs-vsustav-shpric-15-3ml-n1-10_23499/",
                "https://social-apteka.ru/search_to_go/?q=%D0%94%D1%8C%D1%8E%D1%80%D0%B0%D0%BB%D0%B0%D0%BD",
                "https://social-apteka.ru/catalog/bolezni-sustavov/inektran-r-r-din-100mgml-2ml-n10-95_27204/",
                "https://social-apteka.ru/catalog/protivovospalitelnye-sredstva-dlya-oporno-dvigatelnogo-apparata/meloksikam-r-r-din-10mgml-15ml-n5-100_8389805/",
                "https://social-apteka.ru/catalog/obezbolivayushchie/movalis-amp-15mg-15ml-n5-67_20078/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/mukosat-amp-10-1ml-n10-84_16578/",
                "https://social-apteka.ru/catalog/kat/osteokoll-implantat-kollagen-d-periartikulyarnogo-vved-2ml-n5-guna-70_34085377/",
                "https://social-apteka.ru/catalog/kat/pleksatron-kollagen-dvnutrisustav-i-periart-vved-2ml-n5-guna-96_34077275/",
                "https://social-apteka.ru/catalog/kat/ripart-long-sr-vo-dzameshch-sinov-jidk-20mgml-2ml-shpric-n1-ingal-70_32534640/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/ripart-long-sr-vo-dzameshch-sinovialnoy-jidkosti-20mgml-shpric-3ml-n1-rossiya-18_71697/",
                "https://social-apteka.ru/catalog/kat/ripart-forte-sr-vo-dlya-zameshcheniya-sinovialnoy-jidkosti-15mgml-shpric-3ml-100_34077342/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/rumalon-amp-1ml-n10-39_24853/",
                "https://social-apteka.ru/catalog/gomeopatiya/traumel-s-amp-22ml-n5-44_11979/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/fermatron-shpric-1-2ml-n1-77_33430/",
                "https://social-apteka.ru/catalog/bolezni-sustavov/fermatron-shpric-15-2ml-n1-38_34995/",
                "https://social-apteka.ru/catalog/kat/fleksotron-kross-implantant-din-60mg3ml-sayvijn-bayotek-6_32534636/",
                "https://social-apteka.ru/catalog/kat/fleksotron-solo-implant-din-22-22mgml-2ml-sistema-plyus-20_33579271/",
                "https://social-apteka.ru/catalog/kat/fleksotron-ultra-implant-din-25-25mgml-48ml-albomed-63_33593771/",
                "https://social-apteka.ru/catalog/kat/hronotron-implantat-inekc-gel-dlya-vsust-vved-20mgml-2ml-n1-mastelli-61_33593758/"]
            pages = {}
            prep = []
            for i in range(len(linklist)):
                respone = requests.get(linklist[i])
            ...
            with open(f"SocialApteka_{date}.csv", 'a', newline='') as file:
                writer = csv.writer(file, delimiter=';')
                writer.writerow(
                    ['Дата', 'Наименование препарата как у нас', 'Наименование препарата как у аптеки', 'Наименование АС',
                     'Ссылка на препарат', 'Город', 'Цена'])
