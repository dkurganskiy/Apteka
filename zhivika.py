...
linklist = [
    "https://zhivika.ru/search/resultPage?searchString=%D0%90%D0%BC%D0%B5%D0%BB%D0%BE%D1%82%D0%B5%D0%BA%D1%81",
...
for i in range(len(linklist)):
    ...
    items = soup.find_all("a", class_="product-tile__item product-tile-item ")
    if not items:
        print("не туда")
...
print(prep)
with open(
        rf"C:\Users\danil\OneDrive\Документы\Python\Аптечка\Результаты парсинга\zhivika{date}.csv",
